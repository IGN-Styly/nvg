...
public class ItemGridArea implements Component, ItemContainer {
    ...
    public boolean handleRelease(
        ...
        if (
            ...
            // Save the currently dragged item
            ...
            if (this.container.getItemAt(gridpos.y, gridpos.x) != null) {
                ...
                try {
                    ...
                    ctx.from.returnItem(existingItem, ctx.originContext);
            ...
            container.placeItem(draggedItem, gridpos.y, gridpos.x);
    ...
    public void returnItem(InventoryItem item, Object contextData) {
        ...
        if (!this.container.canPlaceItem(item, ctx.y, ctx.x)) {
